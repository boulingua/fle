...
presentation:
  file: "/fle/materials/presentations/unit10_cinema-quebecois-e.odp"
...
### B. Point de langue — exprimer et nuancer une opinion
...
**Structure utile :** *verbe d'opinion + que + indicatif* → *Je trouve **que** l'intrigue **est** bien construite.*
Après *ne pas penser que / ne pas croire que*, on emploie souvent le subjonctif : *Je ne pense pas que ce **soit** un chef-d'œuvre.*

**Connecteurs pour structurer :** *d'abord · ensuite · de plus · en revanche · pour finir.*
{{< /callout >}}

### C. Texte original — mini-présentation orale (modèle)
...
### D. Note culturelle — le cinéma québécois (source ouverte, paraphrasée)
...
1. De quel pays / région vient le film présenté ?
2. Comment le locuteur décrit-il le **rythme** du film ?
3. Quelle **scène** l'a particulièrement ému·e ?
4. Quel est son **avis final** : positif, négatif ou nuancé ? Justifiez.
...
- 1) court extrait publicitaire · 2) qui a reçu un prix · 3) la trame de l'histoire · 4) la liste des noms · 5) la façon de filmer et de diriger

**Ex. 3 — Point de langue.** Complétez avec un verbe ou connecteur d'opinion (plusieurs réponses possibles).

1. ______, je trouve que l'intrigue est bien construite.
2. Le rythme est lent, ______ l'histoire est forte.
3. Je ne pense pas que ce film ______ (être) un chef-d'œuvre, mais il est réussi.
4. ______, je recommande cette œuvre à toute la classe.

**Ex. 4 — Expression guidée.** Transformez ces notes en deux phrases complètes et reliées.
*Notes : film québécois · accent différent · scène émouvante · avis : à voir.*
...
1. le **titre**, l'**année** et le·la **réalisateur·rice** ;
2. l'**intrigue** résumée en 3 phrases (sans tout dévoiler) ;
3. une **scène marquante** (décrite brièvement) ;
4. un **avis nuancé** avec au moins un connecteur (*même si / en revanche / pour finir*).
...
**Tâche 1 — Compréhension orale / audiovisuelle (10 pts).**
L'enseignant·e lit (ou diffuse une présentation orale enregistrée en classe) un texte de type « présentation de film ». Répondez à 5 questions : région/pays du film, réalisateur·rice, sujet/intrigue, une scène citée, avis du locuteur (positif/nuancé/négatif + justification).

**Tâche 2 — Vocabulaire du cinéma (8 pts).**
Complétez 8 phrases à trous avec les mots étudiés (réalisateur·rice, intrigue, scène, générique, mise en scène, bande-annonce, primé, émouvant).

**Tâche 3 — Production orale en continu (12 pts).**
Présentez un film francophone (~90 s) selon les 4 critères de la partie 4. Évaluation selon le barème de la tâche « Produire ».
