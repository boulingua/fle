...
1. Quel conseil Mme Lefèvre donne-t-elle avant même de parler de structure ?
2. Selon vous, pourquoi un discours doit-il viser une **émotion** précise ?
3. Anouk a peur. Que feriez-vous à sa place pour vous préparer ?
...
### B. Cinq figures de style utiles
...
### C. Le discours d'Anouk (texte original)
...
### D. Note culturelle — d'où vient l'art de bien parler ?
...
1. À qui Anouk s'adresse-t-elle dans sa première phrase ?
2. Quelle anecdote raconte-t-elle à propos de la sixième ?
3. Citez trois « pays » que la classe a « traversés ».
4. Quelle est la chute (dernière phrase) du discours ?
...
**Exercice 3 — Construire des triades.** Composez deux triades (trois éléments chacune) sur les thèmes : *amitié* et *avenir*.
Exemple donné : *l'école : des devoirs, des amis, des souvenirs.*

**Exercice 4 — De la phrase plate à la phrase d'orateur.** Réécrivez chaque phrase en y ajoutant la figure demandée.

1. *Nous devons agir.* → ajoutez une **anaphore** (répétez « nous devons »).
2. *L'avenir sera difficile.* → transformez en **métaphore**.
3. *Est-ce que vous êtes prêts ?* → transformez en **question rhétorique** plus forte.

{{< callout type="tip" >}}
**Différenciation.**
**G (base) :** faites les exercices 1 et 2 ; pour l'exercice 3, une seule triade suffit.
**M (standard) :** faites les exercices 1 à 3.
**E (renforcé) :** faites les quatre exercices, puis ajoutez à l'exercice 4 une **gradation** de votre invention.
{{< /callout >}}
...
*Plateforme indépendante, sans lien d'affiliation avec les éditeurs, institutions ou marques cités.*
