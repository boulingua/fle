...
1. Selon Théo et Naïma, quelles sont les deux difficultés de l'épreuve orale ?
2. Qu'appelle-t-on une « phrase-outil » ? Donnez un exemple tiré du dialogue.
3. Pour vous : est-il plus difficile de parler seul(e) ou de dialoguer ? Pourquoi ?
...
### A. Vocabulaire — argumenter et débattre
...
### B. Texte original — Un plan de monologue commenté
...
### C. Note culturelle — Senghor, la parole comme engagement
...
2. Citez les deux arguments « pour » un usage encadré.
3. Quelle est la concession faite dans le texte ?
4. Par quelle question l'auteur relance-t-il le débat en conclusion ?

**Ex. 2 — Connecteurs.** Complétez avec le connecteur qui convient (*tout d'abord · en revanche · par exemple · en somme*).

a) ____, je voudrais présenter le problème.
b) Le sport est bon pour la santé ; ____, il coûte parfois cher.
c) Beaucoup de sports sont gratuits : la course à pied, ____.
d) ____, je pense que chacun devrait pratiquer une activité.

**Ex. 3 — Indicatif ou subjonctif ?** Mettez le verbe entre parenthèses à la forme correcte.

a) Je pense que cette idée (être) ____ juste.
b) Je ne crois pas que cette solution (être) ____ efficace.
c) Il faut que nous (prendre) ____ une décision.
d) À mon avis, on (avoir) ____ raison d'agir vite.
...
a) *« N'est-ce pas trop optimiste ? »* → ____
b) *« Que voulez-vous dire exactement ? »* → ____
c) *« Pouvez-vous illustrer votre idée ? »* → ____
d) *« Vous n'avez pas répondu à ma première question. »* → ____
...
{{< callout type="info" >}}
**Différenciation.** **G :** l'élève dispose d'une liste de connecteurs et de deux phrases-outils affichées ; monologue de 2-3 min. **M :** monologue de 4 min avec plan noté en mots-clés. **E :** monologue de 5 min sans notes rédigées et dialogue de 10 min ; l'élève doit intégrer au moins quatre stratégies de rebond.
{{< /callout >}}
