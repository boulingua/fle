---
title: "Unité 4 — Abitur mock 1 — texte journalistique"
...
- Je traite un **mock Abitur 1** complet (texte
  journalistique).
...
| Schreiben Analyse     | 90 min | 350-400 mots structurés     |
| Sprachmittlung        | 60 min | 280 mots DE → FR            |
| Relecture finale      | 30 min | orthographe + précision     |

### B. 5 critères KMK (Lf BW)

1. **Inhalt** : compréhension + couverture.
2. **Sprache** : richesse + correction.
...
90-180 Schreiben · 180-240 Sprachmittlung · 240-270
relecture.*
...
Réalisez **un Abitur Lf complet** : Verstehen + Analyse +
Sprachmittlung. Auto-évaluation finale + grille KMK.
...
## Exemple d'épreuve — Abitur Lf BW (E, 13e)
...
- **5 critères** : *Aufbau* compte autant que *Sprache* —
  ne pas négliger.
