...
::: {.callout-note}
**Modèle :** Activer → Apporter → S'entraîner → Produire → Réfléchir · **Niveau :** M (Klasse 7)
:::
...
**Tâche 2 — Sprechen mündlich (10 P.)** : dialogue rentrée 1 min.
**Tâche 3 — Schreiben (10 P.)** : ~50 mots sur votre rentrée.
