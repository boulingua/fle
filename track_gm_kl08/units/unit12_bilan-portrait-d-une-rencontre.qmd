...
- Je relie présent (description) + passé composé (événements) +
  futur simple (suite).
- Je clôture le cours Klasse 8 par un texte personnel.
...
>
> Je l'ai rencontrée — par écrit — dès l'Unité 1 de Klasse 8.
...
Cette unité **clôt** le cours **Klasse 8 G+M**. Vous avez :
...
Ce sont les compétences que vous emporterez en Klasse 9.
