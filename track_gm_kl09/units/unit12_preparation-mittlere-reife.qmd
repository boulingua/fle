---
title: "Unité 12 — Préparation Mittlere Reife (révisions)"
...
- Je connais le **format de l'examen** Mittlere Reife BW.
...
### A. Format MSA français BW (extrait)

| Épreuve              | Durée   | Points |
|----------------------|---------|--------|
| Compréhension écrite | 30 min  | 25     |
| Expression écrite    | 60 min  | 30     |
| Sprachmittlung       | 30 min  | 20     |
| Expression orale     | 15 min  | 25     |
| **Total**            | 2h15    | **100**|
...
| 3     | 30'   | Sprachmittlung (Ex. 3 + un autre) |
...
**Tâche 2 — Sprachmittlung (8 P.)** : Ex. 3 (3 phrases).
**Tâche 3 — Schreiben (12 P.)** : votre bilan (~150 mots).
...
- **Bildungsplan-BW Mittlere Reife** :
  <https://www.bildungsplaene-bw.de/>
- **Aperçu Kl. 10 G+M** :
  [Klasse 10 — index](../../track_gm_kl10/index.qmd)
